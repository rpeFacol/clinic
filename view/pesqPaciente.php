...
<div class="container">
    ...
    <form action="#" method="post">
        <fieldset>
            <legend><b>Pesquisar Paciente</b></legend>
        ...
        <div class="panel-body">
            <table class="table table-hover">
                ...
                <?php while ($objetoConsulta = mysqli_fetch_array($rs)) { ?>
                    ...
                    <td class="col-md-1"><?php echo $objetoConsulta['id_paciente']; ?></td>
                    <td class="col-md-1"><?php echo $objetoConsulta['cpf']; ?></td>
                    <td class="col-md-1"><?php echo $objetoConsulta['rg']; ?></td>
                    <td class="col-md-2">
                    <a class="btn btn-primary" href="editPaciente.php?id_paciente=<?php echo $objetoConsulta['id_paciente']; ?>" role="button">Editar</a>
                    <a class="btn btn-danger" href="javascript: if(confirm('Tem certeza que deseja excluir o Paciente <?php echo $objetoConsulta['nome']; ?> ?'))
                        location.href='pesqPaciente.php?ok=excluir&id_paciente=<?php echo $objetoConsulta['id_paciente']; ?>';" role="button">Excluir</a>
                </td>
                    </tr>
                        <?php }  ?>
            </table>
